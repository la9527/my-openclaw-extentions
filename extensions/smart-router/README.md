...
| 키 | 기본값 | 설명 |
|---|---|---|
| `localProvider` | `ollama` | 로컬 provider ID |
| `localModel` | `gemma3:4b` | 로컬 기본 모델 |
| `localBaseUrl` | `http://127.0.0.1:11435` | 로컬 API 주소 |
| `localApi` | `ollama` | `openai` 또는 `ollama` |
