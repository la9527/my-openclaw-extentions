...
5. 응답 첫 줄에 현재 선택된 tier 라벨을 작게 표시할 수 있습니다.

예시 라벨:

```text
<sub>[local/simple]</sub>
<sub>[nano/moderate]</sub>
<sub>[mini/complex]</sub>
<sub>[full/advanced]</sub>
```
...
| `showModelLabel` | `true` | 응답 첫 줄에 짧은 tier 라벨 표시 여부 (`direct` 수동 선택 라벨은 숨김) |
